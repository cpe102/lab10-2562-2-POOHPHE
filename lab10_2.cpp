...
int main(){	
	...
	int yugi_cards[3]={drawCard(),drawCard(),0};
	
	cout << "---------YUGI'S TURN, DRAW!!!------------\n";
	cout << "Yugi's cards: " <<cardNames[yugi_cards[0]]<<" "<<cardNames[yugi_cards[1]]<< "\n";
	yugiScore = calScore(yugi_cards[0],yugi_cards[1],yugi_cards[2]);
	...
	if(yugiAction == 1){
		yugi_cards[2]=drawCard();
		cout << "Yugi draws the 3rd card!!!\n";
		cout << "Yugi's 3rd card: " <<cardNames[yugi_cards[2]] <<"\n";
			yugiScore = calScore(yugi_cards[0],yugi_cards[1],yugi_cards[2]);
